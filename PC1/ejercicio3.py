...
payaso=112
muñeca=75
can_payasos=float(input('Ingrese cantidad de payasos: '))
can_muñecas=float(input('Ingrese cantidad de muñecas: '))

total=round(((can_payasos*112)+(can_muñecas*75)),2)

print(f'Peso total del paquete enviado es de {total} gramos.')
